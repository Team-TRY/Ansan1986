...
public class BusCutsceneTrigger2 : MonoBehaviour
{
    public PlayableDirector timeLine;
    public GameObject busObject;
    public GameObject lever;
    public GameObject animBus;
    public GameObject busChar, busChar2;
    ...
    IEnumerator ResumeGame()
    {
        ...
        busChar2.SetActive(true);
        animChar.SetActive(false);
        animChar1.SetActive(false);
        animChar2.SetActive(false);
    }
}
